...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('api_message', 'subject')

        # Adding field 'MessageThread.subject'
        db.add_column('api_messagethread', 'subject',
    ...
    def backwards(self, orm):
        ...
        db.add_column('api_message', 'subject',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'MessageThread.subject'
        db.delete_column('api_messagethread', 'subject')
